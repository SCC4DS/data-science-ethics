...
-   ChatGPT is by far one of the most advanced LLMs.

-   The model has multi-modal capabilities, suggesting that the model can handle images, text, and sound.
...
-   Up until 2023, chat GPT was only trained on text data up to 2021. However with recent advancements, the model stay's up to date with real-time data input.
