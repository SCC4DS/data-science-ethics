...
## Outliers and anomalies
Dropping outliers and zooming in reveals the relationship more clearly.
```{r}
#| echo: false
...
Zooming in on $7 < x < 9$ and $7 < y < 9$ reveals a band where there are no observations.
...
- What role does the analyst have in identifying any anomalies or data collection errors?

- Can return to a discussion on stories/explanations and [Occam's Razor](https://en.wikipedia.org/wiki/Occam%27s_razor).  It's easy to come up with compelling stories about the data, but often it's something as simple as a mistake in data collection.
