...
Can have students simulate colorblindess on visualizations that students previously generated (e.g. using `colorBlindness`) or experiment with simulators online (e.g. [https://www.color-blindness.com/coblis-color-blindness-simulator/](https://www.color-blindness.com/coblis-color-blindness-simulator/))
