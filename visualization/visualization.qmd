...
- The previous slide is somewhat provocative in the context of storytelling with data.
...
::: {.column width="50%"}
   In 2015, the National Review, a conservative editoral magazine, tweeted a chart that displayed the global temperature in Fahrenheit from 1800 to 2015. Noting that "it was the only chart you need to see".
:::
:::::
...
- We start with default ylimits to match the tweet, but show how the story changes some if we zoom in
- Use the "autoscale" button at the top to zoom in or zoom in manually.  Double clickcing on the plot resets to the default.
...
- Additional plots or results could drive home the story about impact of a 1 degree change.  Hypothetical plots: how much does a 1 degree increase in global temperature impact the prevalance of wildfires? How much does a 1 degree increase impact the abundance of important species in the ecosystem?

- Domain expertise needed to contexualize findings!
...
-   There is also a fine line between poorly constructed visualizations and unethically presentations.
...
<center>![](figures/3d%20graph.png)</center>

## Improved axis limits

<center>![](figures/Improvedgraph.png){width="60%"}</center>
...
<center>![](figures/Colorsequence.png)</center>
...
## {.instructor-note}
For instance, an individuals degree of color blindness may influence the perception of graph or figure. One in every 12 men (8%) and one in every 200 women (0.5%) in the U.S. are born with inherited color defective vision of some type and degree (Johnson, 2024). The most common color-blindness types are red-green and blue-purple. Any color that contains the affected primary color is distorted.
