...
- The previous quote is somewhat provocative in the context of communicating conclusions from data.
...
::: {.column width="50%"}
   In 2015, the National Review, a conservative editoral magazine, tweeted a chart that displayed the global temperature in Fahrenheit from 1800 to 2015. Noting that it was the only chart that someone needed to see.
:::
:::::
...
::: {.column width="50%"}
-  Does this visualization make a point in a service of a larger story?
- Is the point fair or potentially misleading?
:::
:::::
...
- Con: lose control of the narrative, easier for others to distort your findings
  ...
  + Figures should be designed to tell a story and have a clear purpose.  
