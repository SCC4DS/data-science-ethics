...
<center>![](images/petty_theft_arrests1.png){width=50%}</center>

<center>[source](https://www.propublica.org/article/machine-bias-risk-assessments-in-criminal-sentencing])</center>

## Putting a human face on it

<center>![](images/petty_theft_arrests2.png){width=60%}</center>
...
- Understanding the root causes and devising potential solutions is non-trivial!
