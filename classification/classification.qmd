...
- If race is not included as a predictor in the classifer it is not possible in general to match FPR and FNR across both groups!
...
- In fairness literature these constraints are known as "the impossibility of fairness" [@kleinberg2016inherent]
...
- Alternatively, if we use a single "race-blind" classiffier, we could match either FPR or FNR across race groups but not both. Which would be preferable?
