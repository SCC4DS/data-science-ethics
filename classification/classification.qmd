---
title: "Ethical Considerations for Classification Algorithms"
format:
  revealjs: 
    css: custom.css
    slide-number: true
...
<center>![Source: Wikipedia, "Receiver operating characteristic"](figures/Roc_curve.svg.png){width=60%}</center>
